...
namespace Autorization
    ...
    public partial class Form1 : Form
        ...
        public void loadDataBase(string userName, string password)
            ...
            // Подключение к БД
            string pathToDataBase = Application.StartupPath + "/db.accdb";
            OleDbConnection connectToDataBase = new OleDbConnection("Provider=Microsoft.ACE.OLEDB.12.0;Data Source=" + pathToDataBase);
